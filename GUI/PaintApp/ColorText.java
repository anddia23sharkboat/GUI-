...
public class ColorText {
 ...
 //create elements in the Constructor
  public ColorText(){    
   ...
   label1 = new JLabel("The is going to the park"); 
   label2 = new JLabel("Kid named Finger");
   label3 = new JLabel("I am the one who knocks");
   label4 = new JLabel("Hello Ms. Orsun!");
   ...
   //add each button to panel for buttons
    ...
    button2.addActionListener(e->changeText(button1) );
    button3.addActionListener(e->changeText(button1) );
    button4.addActionListener(e->changeText(button1) );
  ...
  public void changeText(ColorButton button_parameter) {
    label1.setForeground(button_parameter.getColor());
    label2.setForeground(button_parameter.getColor());
    label3.setForeground(button_parameter.getColor());
    label4.setForeground(button_parameter.getColor());
